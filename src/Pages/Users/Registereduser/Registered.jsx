...
function Registered(props) {
  ...
  useEffect(() => {
    getregistereduser("registered", page).then((res) => setRegisteredUser(res));
  }, [flag, page]);
    ...
    <div>
      <div className="overflow-auto h-[400px] mt-6 border">
        <div className="mx-6 flex flex-col md:flex-row  justify-between h-12 text-sm">
          <div className="flex  gap-3">
            <div className="flex items-center gap-1">
              ...
              <p className="w-20">De-Activate</p>
            </div>
            <div className="flex items-center gap-1">
          ...
          <div className="flex  items-center gap-1">
            <UserPagination
              pages={registeredUser[0]?.PageSize}
              changepage={changepage}
              page={page}
              setpage={setpage}
              TotalPageCount={registeredUser[0]?.TotalPageCount}
        ...
        <table className="w-full  ">
          <thead className=" ">
            <tr className=" md:h-12 text-white overflow-hidden mt-2 sticky top-0 gap-1  bg-[#680d0d]">
          ...
          <tbody
           ...
           lg:top-0  md:top-14      "
          >
            {(props.filteredresult[0] ? props.filteredresult : registeredUser)
